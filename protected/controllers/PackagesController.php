...
class PackagesController extends Controller
{
	...
	{
		Login::UserAuth('Packages','Create');		
		$model=new Packages;
		...
		{
			$_POST['Packages'] = CI_Security::ChkPost($_POST['Packages']);
			
			$model->attributes = $_POST['Packages'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->pkgid));
		}
	...
	{
		Login::UserAuth('Packages','Update');	
		$model=$this->loadModel($id);
	...
	{
		Login::UserAuth('Packages','Delete');	
	...
	{
		Login::UserAuth('Packages','Admin');	
		$model=new Packages('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Packages']))
		{
			$_GET['Packages'] = CI_Security::ChkPost($_GET['Packages']);
